...
use crate::windows::source::WindowsSource;
...
) -> Result<HostIdentity, CollectError> {
...
mod tests {
    use super::*;
    use crate::windows::source::MockWindowsSource;
    ...
    fn error_propagated() {
        ...
        assert_eq!(err.kind, crate::error::CollectErrorKind::SourceUnavailable);
    }
    ...
    fn empty_hostname_rejected() {
        ...
        assert_eq!(err.kind, crate::error::CollectErrorKind::Parse);
    }
