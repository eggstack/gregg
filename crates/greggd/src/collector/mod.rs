...
/// Shared drive normalization, re-exported from `gregg-host` (Plan 135).
/// Production normalization lives in the host crate; this path is preserved
/// for the frozen compatibility tests.
pub(crate) mod drives {
    #![allow(unused_imports)]
    pub(crate) use gregg_host::drives::{normalize, normalize_with_limits, DriveCandidate};
}

/// Shared counter baselines, re-exported from `gregg-host` (Plan 135).
pub(crate) mod rate {
    #![allow(unused_imports)]
    pub(crate) use gregg_host::rate::{CounterBaselines, CounterRates, CounterSample};
}
...
/// Slow-probe cache, re-exported from `gregg-host` (Plan 135).
#[allow(dead_code, unused_imports)]
pub(crate) use gregg_host::DriveRefreshCache;

/// Shared percentage helpers, re-exported from `gregg-host` (Plan 135).
#[allow(unused_imports)]
pub(crate) use gregg_host::{clamped_usage_pct, finalize_percentage};
