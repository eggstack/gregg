...
| `control` | `src/control.rs` | Unix-domain control socket for `greggd stop`; canonicalized existing-file/lexical-missing config identity, config-adjacent primary + temp-dir fallback paths |
