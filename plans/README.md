...
| Plan | Purpose | Status |
| --- | --- | --- |
| [`063-narrow-correctness-and-simplification-roadmap.md`](063-narrow-correctness-and-simplification-roadmap.md) | Correct the remaining bounded status/protocol/package defects, then simplify duplicated verification and measured client footprint without feature expansion | Phase 64 completed; Phase 65 implementation complete pending hosted CI closure |
...
| [`065-proportionate-verification-and-footprint-cleanup.md`](065-proportionate-verification-and-footprint-cleanup.md) | Reduce duplicate local/CI commands and apply only measured low-risk Tokio feature/runtime cleanup while preserving native coverage and Rust 1.75 | implementation complete pending hosted CI closure; depends on 064 |
