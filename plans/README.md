...
| [`132-native-host-telemetry-extraction-and-bsd-portability-roadmap.md`](132-native-host-telemetry-extraction-and-bsd-portability-roadmap.md) | Coordinate regression-controlled native telemetry extraction and FreeBSD-first portability | complete; coordinated 133-136 at `a9dab65`+`a5624a9`+`43b5cf3`+`d928950`; CI `36219678790` green |
| [`133-native-collector-compatibility-characterization-and-boundary-freeze.md`](133-native-collector-compatibility-characterization-and-boundary-freeze.md) | Freeze collector/public-path/wire/readiness/rate/slow-probe behavior before moving source | complete; implementation `a9dab65`+`a5624a9`+`43b5cf3`+`d928950`; CI `36219678790` green |
| [`134-gregg-host-native-telemetry-crate-extraction.md`](134-gregg-host-native-telemetry-crate-extraction.md) | Extract protocol-neutral Linux/macOS/Windows native telemetry into working `gregg-host` crate | complete; implementation `a9dab65`+`a5624a9`+`43b5cf3`+`d928950`; CI `36219678790` green |
| [`135-greggd-gregg-host-adapter-cutover-and-qualification.md`](135-greggd-gregg-host-adapter-cutover-and-qualification.md) | Cut greggd over through a compatibility facade and prove exact native/v1/v2/MSRV equivalence | complete; implementation `a9dab65`+`a5624a9`+`43b5cf3`+`d928950`; CI `36219678790` green |
| [`136-freebsd-first-native-telemetry-and-bsd-portability-foundation.md`](136-freebsd-first-native-telemetry-and-bsd-portability-foundation.md) | Add FreeBSD as the first post-extraction native backend and establish BSD portability seams | complete; implementation `a9dab65`+`a5624a9`+`43b5cf3`+`d928950`; CI `36219678790` green; swap/counter-cross-check follow-ups recorded |
