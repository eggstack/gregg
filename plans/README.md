...
| [`016-v1.0.1-release-integrity-and-evidence-closure.md`](016-v1.0.1-release-integrity-and-evidence-closure.md) | Bind every gate to one candidate and package provenance, enforce complete evidence, and publish/verify `1.0.1` | Verified tagged, published, package-proven, and registry-installed `1.0.1` release | implementation pass landed; native/protected/publication closure pending |
